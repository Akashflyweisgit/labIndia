            ...
            <AppBar position="fixed" className="MainHeader">
                <Toolbar className="header_padding">
                    ...
                    <span className='pr-3'><img src={sikhlo} alt="" height="50" /></span>
                        ...
                        <span className='pl-3 mt-1' style={{color:"#b0dd36"}}><h4>LabIndia</h4></span>
                    </div>
                    ...
                    <div className="mobile_Burger_Menu">
                        ...
                        <div id="mySidenav" className="sidenav">
                            ...
                            <span className="logout_Pointer_cursor mt-2" onClick={() => navigate("/post-list")}>
                            Posts
                            </span>
                            <span className="logout_Pointer_cursor mt-2" onClick={() => navigate("/subscriber")}>
                            Subscriber
                            </span>
                            <span className="logout_Pointer_cursor mt-2" onClick={() => navigate("/plane")}>
                            Our Plan
                            </span>
                            <span className="logout_Pointer_cursor mt-2" onClick={() => navigate("/categories")}>
                           Categories
                            </span>
                            <span className="logout_Pointer_cursor mt-2" onClick={() => navigate("/trading")}>
                            Trading Post
                            </span>
                            <span className="logout_Pointer_cursor mt-2" onClick={() => navigate("/leatest-post")}>
