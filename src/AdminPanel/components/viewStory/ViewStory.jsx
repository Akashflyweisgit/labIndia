          ...
          <Wrapper>
            ...
            <DetailsWrapper>
              <CardDetails>
                ...
                <h5>
                  {" "}
                  Parents Name : <span>{name}</span>{" "}
                </h5>
                <h5>
                  {" "}
                  Child Name : <span>Child 1</span>
                </h5>
                <h5>
                  {" "}
                ...
                <h5>
                  {" "}
                  Relationship : <span> Draughter</span>
                </h5>
                <h5>
                  {" "}
                  Total Number of Children : <span> 12</span>
                </h5>
                <h5>
                  {" "}
                  Child Gender : <span>Female</span>{" "}
                </h5>
              </CardDetails>
              <CardDetails>
                <h4>Address</h4>
                <h5>
                  Address : <span>New Delhi</span>{" "}
                </h5>
                <h5>
                  Country : <span> India </span>{" "}
                </h5>
                <h5>
                  City : <span> Noida </span>{" "}
                </h5>
                <h5>
                  State : <span> Noida </span>{" "}
                </h5>
                <h5>
                  Pin : <span> 110089 </span>{" "}
                </h5>
              </CardDetails>
            </DetailsWrapper>
          </Wrapper>
